    ...
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form" @submit.prevent="login">
          ...
          <p v-if="errors.has('email') || errorsResponse.email" class="alert-validation">{{errors.first('email') || errorsResponse.email[0]}}</p>
          ...
          <p v-if="errors.has('password') || errorsResponse.password" class="alert-validation">{{errors.first('password') || errorsResponse.password[0]}}</p>
